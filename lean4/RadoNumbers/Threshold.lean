...
/-- **Round 119 (2026-05-15):** Verified breakdown at $(b, k) = (2, 3)$:
...
/-- **Round 120 (2026-05-15):** Verified breakdown at $(b, k) = (2, 4)$:
...
/-- **Round 121 (2026-05-15):** Verified breakdown at $(b, k) = (2, 5)$:
...
/-- **Round 122 (2026-05-15):** Verified breakdown at $(b, k) = (2, 6)$:
...
/-- **Round 123 (2026-05-15):** Verified breakdown at $(b, k) = (2, 7)$:
...
/-- **Round 124 (2026-05-15):** Verified breakdown at $(b, k) = (2, 8)$:
...
/-- **Round 126 (2026-05-15):** STRONGER breakdown bound at $(b, k) = (2, 3)$:
...
/-! ### Round 125 (2026-05-15) — cumulative breakdown evidence at $b = 2$. -/
...
/-! ### Round 40 (2026-05-15) — cascade architecture validated at
...
/--
  **Round 40 Lemma — `CascadeCompressionHyp 3 4` holds (vacuously).**
...
/--
  **Round 40 Theorem — `thm_k4b3_via_cascade_matching`: $R_4(3) =
...
/-! ### Round 45 (2026-05-15) — the cascade compression hypothesis
  ...
  derived purely as a CONSEQUENCE of the architecture (Round 42)
...
/--
  **Round 45 Theorem — `CascadeCompressionHyp 3 5` is FALSE.**
